...
r2_ridge <- ridge_eval %>% filter(metric=='r2') %>% group_by( feat1) %>% summarise(mean=mean(value))
...
clf_eval <- rbind(mlc_eval, mlb_eval) %>% filter(metric=='balanced_accuracy') %>% mutate(feats=paste0(feat1,'_', feat2, '_', type))

clf_tst <- clf_eval %>% pairwise_t_test(value ~ feats,p.adjust.method='bonferroni')
...
ggsave('/Users/dwiepert/Documents/Grad_School/Huth/data/data/new_results/fbank.png', height=5, width=4.5
)

p2 <- ridge_plot(df = ridge %>% filter(feat2=='FBANK-40'))
ggsave('/Users/dwiepert/Documents/Grad_School/Huth/data/data/new_results/fbank40.png', height=5, width=4.5
)

p3 <- ridge_plot(df = ridge %>% filter(feat2=='ComParE 2016'))
ggsave('/Users/dwiepert/Documents/Grad_School/Huth/data/data/new_results/opensmile.png', height=5, width=4.5)
       
p4 <- ridge_plot(df = ridge %>% filter(feat2=='Word Embedding'))
ggsave('/Users/dwiepert/Documents/Grad_School/Huth/data/data/new_results/word.png', height=5, width=4.5
)

gg <- ggarrange(p2, p3, p4, nrow=1, ncol=3, common.legend=TRUE,legend="right")
 
ggsave('/Users/dwiepert/Documents/Grad_School/Huth/data/data/new_results/ridge.png', height=4, width=12)
...
ggsave('/Users/dwiepert/Documents/Grad_School/Huth/data/data/new_results/multiclass_clf.png', height=7, width=8)
...
ggsave('/Users/dwiepert/Documents/Grad_School/Huth/data/data/new_results/multiclass_clf_bacc.png', height=4, width=8)
...
ggsave('/Users/dwiepert/Documents/Grad_School/Huth/data/data/new_results/all_clf_bacc.png', height=4, width=12)
...
ggsave('/Users/dwiepert/Documents/Grad_School/Huth/data/data/new_results/all_performance.png', height=8, width=12)
...
ridge <- ridge %>% mutate(feature=factor(feat1), correlation=values) %>% select(feature, correlation, feat2)

my_comparisons <- list(c("ema","emawav"), c("ema","lstsq"),c("ema", "wavlm-large.9"), c("emawav","lstsq"), c("emawav", "wavlm-large.9"), c("lstsq", "wavlm-large.9"))
fbank <- ridge %>% filter(feat2=='fbank') %>% ggplot( aes(feature, correlation, fill=feature)) + geom_boxplot()+
  scale_fill_discrete_sequential(palette="ag_Sunset") + ggtitle('FBANK23') + theme(plot.title = element_text(hjust = 0.5))+ stat_compare_means(comparisons = my_comparisons, label="p.signif")
ggsave('/Users/dwiepert/Documents/Grad_School/Huth/data/data/resultsv2/fbank23.png', height=5, width=5)
fbank40 <- ridge %>% filter(feat2=='fbank40') %>% ggplot( aes(feature, correlation, fill=feature)) + geom_boxplot()+
  scale_fill_discrete_sequential(palette="ag_Sunset") + ggtitle('FBANK40') + theme(plot.title = element_text(hjust = 0.5))+ stat_compare_means(comparisons = my_comparisons, label="p.signif")
ggsave('/Users/dwiepert/Documents/Grad_School/Huth/data/data/resultsv2/fbank40.png', height=5, width=5)

os <- ridge %>% filter(feat2=='opensmile') %>% ggplot( aes(feature, correlation, fill=feature)) + geom_boxplot()+
  scale_fill_discrete_sequential(palette="ag_Sunset") + ggtitle('openSMIILE') + theme(plot.title = element_text(hjust = 0.5))+ stat_compare_means(comparisons = my_comparisons, label="p.signif")
ggsave('/Users/dwiepert/Documents/Grad_School/Huth/data/data/resultsv2/opensmile.png', height=5, width=5)

p < ggarrange(fbank, fbank40, os,nrow=1, ncol=3)
  



  hcl.colors(name="ag_Sunset")
summ2 <- ridge %>% group_by(feat1,feat2) %>% summarize(mean=mean(values))
ggsave('/Users/dwiepert/Documents/Grad_School/Huth/data/data/resultsv2/ridge_plot1.png', height=7, width=12)
...
ggsave('/Users/dwiepert/Documents/Grad_School/Huth/data/data/resultsv2/ridge_plot2.png', height=5, width=10)
